...
- **DD3 — iPad multitasking/Stage Manager support:** deferred behind `UIRequiresFullScreen`. Settled by a resize-matrix test pass after Phase 7.
...
9. **Stage Manager/multitasking behavior** once `UIRequiresFullScreen` is lifted (DD3). Resolved by a dedicated resize test pass post-v1.
